...
@section('content')
    ...
    {!! Form::open([
        'url' => route('admin.bank.update', $currentBank->id),
        'method'=>'POST',
        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('bank_name')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="bank_name" name="bank_name" value="{{ $currentBank->bank_name }}" class="form-control" id="bank_name" placeholder="Nama Bank">
            ...
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('bank_account')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="bank_account" name="bank_account" value="{{ $currentBank->bank_account }}" class="form-control" id="bank_account" placeholder="Akun Bank">
            ...
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('description')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="description" name="description" value="{{ $currentBank->description }}" class="form-control" id="description" placeholder="Keterangan">
