...
@section('content')
    ...
    <div class="card col-12">
        <div class="card-header">
            <h3 class="card-title">Tambah Setting</h3>
        </div>
        <div class="card-body">
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('slug')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="slug" name="slug" class="form-control" id="slug" placeholder="Akun Bank">
                        @if($errors->has('slug'))
            ...
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('category')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="category" name="category" class="form-control" id="category" placeholder="Keterangan">
