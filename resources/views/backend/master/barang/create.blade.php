        ...
        <div class="card-body">
            ...
            <div class="form-group row col-sm-12">
                <div class="form-group @if($errors->has('poin')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input value="{{ old('poin') }}" type="number" name="poin" class="form-control" id="poin" placeholder="Poin" min="0" required>
                        @if($errors->has('poin'))
                ...
                <div class="form-group @if($errors->has('diskon')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input value="{{ old('diskon') }}" type="number" name="diskon" class="form-control" id="diskon" placeholder="Diskon" min="0">
