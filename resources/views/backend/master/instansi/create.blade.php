        ...
        <div class="card-body">
            <div class="row">
                <div class="form-group col-sm-6 @if($errors->has('no_pelanggan')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="no_pelanggan" name="no_pelanggan" class="form-control" id="no_pelanggan" placeholder="ID Pelanggan">
                ...
                <div class="form-group col-sm-6 @if($errors->has('nama_instansi')) has-error @endif">
                    ...
                    <div class="col-sm-12">
                        <input type="nama_instansi" name="nama_instansi" class="form-control" id="nama_instansi" placeholder="Instansi">
