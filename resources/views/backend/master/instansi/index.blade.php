    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="float-right">
                <a href="{{ route('admin.instansi.add') }}" class="btn btn-block btn-info">
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-bordered table-hover" id='instansi-table'>
                <thead>
                    <tr>
                        <th>No</th>
                        <th>ID Pelanggan</th>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            dataTable = $('#instansi-table').DataTable({
                processing: true,
                serverSide: true,
                stateSave: false,
                // dom: '<"top">rt<"bottom"ilp><"clear">',
                ajax: '{!! route('admin.instansi.datatable') !!}',
                orderCellsTop: true,
                columns: [
                    {
                        data: null,
