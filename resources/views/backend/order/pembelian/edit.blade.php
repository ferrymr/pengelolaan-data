...
@section('content')
    ...
    {!! Form::open([
        'url' => route('admin.pembelian.update', $data->id),
        'method'=>'POST',
    ...
    <div class="card col-12">
        <div class="card-header">
            <h3 class="card-title">Ubah Pembelian</h3>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <input value="{{ $data->no_po }}" type="text" name="no_po" class="form-control" id="no_po" placeholder="Code" readonly required>
                    @if($errors->has('no_po'))
            ...
            <div class="form-group col-md-6 @if($errors->has('kode_supp')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <input type="text" name="kode_supp" class="form-control" id="kode_supp" placeholder="Kode Supplier"  value="{{ $data->kode_supp }}">
            ...
            <div class="form-group col-md-6 @if($errors->has('nama')) has-error @endif">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nama_supp" class="form-control" id="nama" placeholder="Nama Supplier" readonly="true"  value="{{ $data->nama }}">
                    @if($errors->has('nama'))
        ...
        <table class="table table-hovered table-striped table-bordered form-table" id="pembelian-add">
            ...
            <tbody>
                ...
                <tr class="detailLine">
                    <td>
                        <input type="text" name="kode_barang[]" class="form-control" id="kode_barang" value="{{ $item->kode_barang }}" placeholder="Kode Barang" >
                    </td>
                    <td>
                        <input type="text" name="nama[]" class="form-control" id="nama" placeholder="Nama" readonly="true"  value="{{ $item->nama }}">
                    </td>
                    <td>
                        <input type="text" name="jenis[]" class="form-control" id="jenis" placeholder="Jenis" readonly="true" value="{{ $item->jenis }}">
                    </td>
                    <td>
                        <input type="number" name="jumlah[]" class="form-control input-jumlah" id="jumlah" min="1" value="{{ $item->jumlah }}" placeholder="Qty" >
                    </td>
                    <td>
                        <input type="text" name="harga[]" class="form-control input-harga" id="harga" placeholder="Harga" readonly="true" value="{{ $item->harga }}">
                    </td>
                    <td>
                        <input type="text" name="total[]" class="form-control input-total" id="total" readonly="true" placeholder="Total" value="{{ $item->total }}">
                    </td>
            ...
            <tfoot>
                <tr class="grandTotal">
                    ...
                    <td style="border: none"></td>
                    <td>Total :</td>
                    <td><input type="text" name="sub_total" class=" form-control grand-total" id="sub_total" value="{{ $data->sub_total }}" readonly="true"></td>
                    <td style="text-align: center"> <button type="submit" class="btn btn-info">Update</button></td>
                </tr>
            </tfoot>
        </table>        
    </div>    
