    ...
    <div class="invoice p-3 mb-3">
        ...
        <div class="row invoice-info">
          ...
          <div class="col-sm-4 invoice-col">
            ...
            <address>
              ...
              {{-- {{ $data->user->kota_nama }},
              {{ $data->user->kecamatan_nama }}, 
              {{ $data->user->provinsi_nama }}<br> --}}
              Phone: {{ $data->phone}}<br>
              Email:  {{ $data->email }}
            </address>
          </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td>@currency($item->harga) / {{ $data->kurir }}</td>
                  </tr>
                  <tr>
                    <th>Total:</th>
                    <td>@currency($data->sub_total + $item->harga)</td>
                  </tr>
                </table>
              </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              @else
                {!! Form::open([
                  'url' => route('admin.penjualan.update-status', $data->id),
                  'method'=>'POST',
                  ...
                  <div class="form-group col-md-6 float-right">
                      ...
                      <div class="col-sm-9">
                          ...
                          <a href="{{ route('admin.penjualan.index') }}" target="" class="btn btn-default float-left">
                            Back
                          </a>
                      </div>
                  </div>
