...
<div class="card col-12">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-6 @if($errors->has('tgl_pembayaran')) has-error @endif">
                ...
                <div class="col-sm-12">
                    <input type="date" name="tgl_pembayaran" class="form-control" value="{{ $currentPembayaran->tgl_pembayaran }}" id="tgl_pembayaran" placeholder="Tanggal Pembayaran">
        ...
        <div class="row">
            <div class="form-group col-sm-6 @if($errors->has('total_mbps')) has-error @endif">
                ...
                <div class="col-sm-12">
                    <input type="number" name="total_mbps" class="form-control" value="{{ $currentPembayaran->total_mbps }}" id="total_mbps" placeholder="Total Mbps">
            ...
            <div class="form-group col-sm-6 @if($errors->has('nominal_pembayaran')) has-error @endif">
                ...
                <div class="col-sm-12">
                    <input type="number" name="nominal_pembayaran" class="form-control" value="{{ $currentPembayaran->nominal_pembayaran }}" id="nominal_pembayaran" placeholder="Nominal Pembayaran">
                ...
                <div class="col-sm-12">
                    <select name="status" id="status" class="select2" style="width:100%" required>
                        ...
                        <option value="Belum Lunas">Belum Lunas</option> --}}
                            ...
                            <option value="Lunas" @if($currentPembayaran->status == 'Lunas') selected @endif>Lunas</option>
                            <option value="Belum Lunas" @if($currentPembayaran->status == 'Belum Lunas') selected @endif>Belum Lunas</option>
                    </select>
                </div>
            </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-6 @if($errors->has('photo')) has-error @endif">
            ...
            <div class="col-sm-12">
                <input type="file" name="photo" class="form-control" id="photo" value="{{ $currentPembayaran->photo }}" placeholder="Bukti Transfer" accept="image/*">
                @if($errors->has('photo'))
