                                            ...
                                            <li class="product-cart mini_cart_item">
                                                ...
                                                <div class="product-details">
                                                    ...
                                                    <span class="product-price">
                                                        <span class="price">
                                                            <span>@currency($cartItem['h_nomem'])</span>
                                                        </span>
                                                    </span>
                                        ...
                                        @if (Route::has('register'))
                                            <div id="header-tab-rigister" class="tab-panel">
                                                <form method="POST" action="{{ route('register') }}" class="register form-register">
                                                    ...
                                                    <p class="form-row form-row-wide">
                                                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Nama Lengkap" class="input-text @error('name') is-invalid @enderror" required/>
                                                    </p>
                                                    <p class="form-row form-row-wide">
                                                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Email" class="input-text @error('email') is-invalid @enderror" required/>
                                                    </p>
                                                    <p class="form-row form-row-wide">
                                                        <input type="password" name="password" class="input-text @error('password') is-invalid @enderror" placeholder="Password" required>
                                                    </p>
                                                    <p class="form-row form-row-wide">
                                                        <input type="password" name="password_confirmation" class="input-text" placeholder="Re-type Password" required>
                                                    </p>
                                                    <p class="form-row">
